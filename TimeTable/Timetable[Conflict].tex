...
1st wk Sep & You & Schedule practice job talk in appropriate JHU workshop
\\ & & Inform JMCC and JMPO if you are even {\it thinking}
\\ & & about being on the market
\\ \hline
9/1 - 12/1  & You & Read every issue of JOE searching for good job matches
\\ \hline
mid-Sep & You & Write and post self-descriptive memo, \texttt{MemoMoniker.pdf} 
...
\\ & & 
 \texttt{AbstractMoniker.pdf} and \texttt{CVMoniker.pdf}
\\ & & and complete your \texttt{template.txt} file
\\ & & per instructions from the \texttt{JMCC}
\\ \hline
By Oct 18 & You & Meet with advisor(s) to talk about placement 
\\ & Advisor & desires, options, and prospects
\\ \hline
3rd week Oct & Staff & Mass mailing of CV's and abstracts % True deadline to finish: Oct 31
\\ 
& You & (You will need to volunteer to help with this)
\\ \hline
Mid-Oct & Me, JMCC & JHU Job Market web page ``goes public''
\\ \hline
% mid-late Oct & IMF & IMF Interviews conducted \\ \hline
By Nov 1 & You & Job paper should be final, polished, complete 
\\ \hline
$\mathsf{T}[-3to4w]$ & You+Advisors & Discuss list of places you intend to apply to
\\ \hline
$\mathsf{T}[-2to3w]$ & You+Advisors & {\it Finalize} list of places you intend to apply to
\\ \hline
$\mathsf{T}[-2w]$ & You        & Send your Acorn (cover letter, CV, abstract, job paper) \\ \cline{2-3}
& Advisors & Send letters (YOU give mailing labels to staff)
\\ \hline
$\mathsf{T}[-5d]$ & You & Pester references to {\it make sure} all letters have been sent
\\ \hline % This is the true deadline
% Mid Oct-Mid Nov & Fed & Hopkins campus interviews by Fed may occur \\ \hline
Around Dec 2       &  You       & \href{http:/www.aeaweb.org/joe/signal/}{\bf ``Signal''} given   \\
Dec 1-Jan 5 &  Employers & Interested employers schedule ASSA meeting interviews
\\ \hline
Early Dec & Me, You & Mock interviews with JHU faculty
...
\begin{center}
\centerline{\it Expected Dissertation Status}
